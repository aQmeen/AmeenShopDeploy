...
module.exports = __webpack_require__(/*! E:\MY\courses\Angular\Projects\AmeenShop\src\main.ts */"zUnb");
...
NavBarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NavBarComponent, selectors: [["nav-bar"]], decls: 27, vars: 0, consts: [[1, "navbar", "navbar-expand-md", "navbar-dark", "bg-dark", "fixed-top"], ["routerLink", "/", 1, "navbar-brand"], ["aria-expanded", "false", "aria-controls", "navbarsExampleDefault", "aria-label", "Toggle navigation", "type", "button", "data-toggle", "collapse", "data-target", "#navbarsExampleDefault", 1, "navbar-toggler"], [1, "navbar-toggler-icon"], ["id", "navbarsExampleDefault", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "mr-auto"], [1, "nav-item", "active"], ["routerLink", "/shopping-cart", 1, "nav-link"], [1, "sr-only"], ["routerLink", "/login", 1, "nav-link"], ["ngbDropdown", "", 1, "nav-item", "dropdown"], ["ngbDropdownToggle", "", "id", "dropdown01", "aria-expanded", "false", "aria-haspopup", "true", "data-toggle", "dropdown", 1, "nav-link", "dropdown-toggle"], ["ngbDropdownMenu", "", "aria-labelledby", "dropdown01", 1, "dropdown-menu"], ["routerLink", "/orders", 1, "dropdown-item"], ["routerLink", "/admin/orders", 1, "dropdown-item"], ["routerLink", "/admin/products", 1, "dropdown-item"]], template: function NavBarComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nav", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "a", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2, "Ameen Shop");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 28, vars: 0, consts: [[1, "form-signin"], [1, "text-center", "mb-4"], ["width", "72", "height", "72", "alt", "", "src", "https://getbootstrap.com/docs/4.0/assets/brand/bootstrap-solid.svg", 1, "mb-4"], [1, "h3", "mb-3", "font-weight-normal"], ["href", "https://caniuse.com/#feat=css-placeholder-shown"], [1, "form-label-group"], ["id", "inputEmail", "autofocus", "", "required", "", "type", "email", "placeholder", "Email address", 1, "form-control"], ["for", "inputEmail"], ["id", "inputPassword", "required", "", "type", "password", "placeholder", "Password", 1, "form-control"], ["for", "inputPassword"], [1, "checkbox", "mb-3"], ["type", "checkbox", "value", "remember-me"], ["type", "submit", 1, "btn", "btn-lg", "btn-primary", "btn-block"], [1, "mt-5", "mb-3", "text-muted", "text-center"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
ProductsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductsComponent, selectors: [["app-products"]], decls: 2, vars: 0, template: function ProductsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "products worksaa!");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
